...
const fr = {
  ...
  stateLabels: { pending: "En préparation", registered: "En attente de paiement", paid: "Payée", declined: "Refusée", reversed: "Annulée", refunded: "Remboursée", unknown: "En vérification", review: "À vérifier", failed: "Échec d'enregistrement" },
...
const en: typeof fr = {
  ...
  stateLabels: { pending: "Preparing", registered: "Awaiting payment", paid: "Paid", declined: "Declined", reversed: "Cancelled", refunded: "Refunded", unknown: "Being verified", review: "Needs review", failed: "Registration failed" },
  product: "Demo item",
  quantity: "Quantity",
...
const ar: typeof fr = {
  ...
  stateLabels: { pending: "قيد التحضير", registered: "بانتظار الدفع", paid: "مدفوع", declined: "مرفوض", reversed: "ملغى", refunded: "مسترد", unknown: "قيد التحقق", review: "يحتاج مراجعة", failed: "فشل التسجيل" },
  product: "منتج تجريبي",
  quantity: "الكمية",
